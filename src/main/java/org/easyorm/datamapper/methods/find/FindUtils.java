...
import org.easyorm.datamapper.queryBuilders.SelectQueryBuilder;
...
public class FindUtils<T> {
    ...
    public Query findFromManyToManyRelation(Entity searchedEntity, Entity entity, Relation relation, Object entityPrimaryKeyValue) {
        // TODO convert =>
        //  SELECT userr.cin,userr.cne,userr.name,userr.email,userr.lastName,userr.age *
        //  FROM userr,filiere,filiere_userr
        //  WHERE filiere_userr.filiere_cin = ?
        //      AND  filiere_userr.userr_nom = ?
        //      AND  filiere.nom = ?
...
//                filiere,
//                filiere_userr
//        WHERE filiere_userr.filiere_cin = filiere.nom
//        AND filiere_userr.userr_nom = userr.cin
//        AND  filiere.nom = ?
        SelectQueryBuilder selectQueryBuilder = new SelectQueryBuilder();
